...
import static com.lvmama.pangolin.core.ProjectConstant.*;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/orderfood";
    ...
    private static final String AUTHOR = "zhoutianqi";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date

    public static void main(String[] args) {
        genCode("hotel_new_product");
    }
    ...
    public static void genService(String tableName) {
        try {
            ...
            data.put("servicePath", SERVICE_PACKAGE);
            data.put("serviceImplPath", SERVICE_IMPL_PACKAGE);
